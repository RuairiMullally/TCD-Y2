...
//Ruairi Mullally, edited to fix bug with test case 2.
...
void test2() {
  ...
  std::cout << "Does the list contain 'the'? " << textAnalyser.listA.Contains("the")
            << std::endl;
  std::cout << "Does the list contain 'them'? " << textAnalyser.listA.Contains("them")
            << std::endl;
}
